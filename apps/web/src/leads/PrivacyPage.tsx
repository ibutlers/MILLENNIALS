...
export function PrivacyPage() {
  useEffect(() => setPageMetadata('Privacidad provisional | MILLENNIALS CONSTRUYEN', 'Información provisional sobre la captación de solicitudes en MILLENNIALS CONSTRUYEN pendiente de revisión legal.'), []);
  return (
