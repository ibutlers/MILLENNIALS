...
| `/inversores/verificacion` | `InvestorVerification` | `GET /api/investor/verification` | Flujo preparatorio KYC; proveedor externo pendiente |
...
### Verificación
- **API:** `GET /api/investor/verification` consulta `providers.kyc.health()` dentro de las rutas privadas Better Auth.
